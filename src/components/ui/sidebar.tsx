      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh has-[[data-variant=inset]]:bg-sidebar fixed",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-white text-sidebar-foreground shadow-lg",
            className
          )}
          ref={ref}
          {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-row gap-2 p-2 items-center", className)}
      {...props}
    />
  )
})
